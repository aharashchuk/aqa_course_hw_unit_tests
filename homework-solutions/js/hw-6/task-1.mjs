...
const toDestructure = [3, 11, 32, 7, 20];
const [first, second, ...rest] = toDestructure;
...
const oneToFive2 = [1, 2, 3, 4, 5];
const sixToTen = [6, 7, 8, 9, 10];
const mergedArray = oneToFive2.concat(sixToTen);
